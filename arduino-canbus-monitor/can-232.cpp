...
INT8U Can232::parseAndRunCommand() {
    ...
    case LW232_CMD_ACC_CODE:
        ...
        ret = LW232_OK;//LW232_ERR_NOT_IMPLEMENTED; 
        break;
    ...
    case LW232_CMD_TIMESTAMP:
        ...
        break;
     case LW232_CMD_SETFILTERMD:
        // The command D1[CR] switch on the dual filter mode and with D0[CR] you switch overto the single filter mode.
        if (lw232CanChannelMode == LW232_STATUS_CAN_CLOSED) {
