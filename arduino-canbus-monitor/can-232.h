...
#define LW232_CMD_OPENSELF  'Y' //   YES       Y[CR]                Open the channel in the self reception mode.
...
#define LW232_CMD_SETFILTERMD  'D' //   NO       Dn[CR]               Set Filter Mode SINGLE OR DUAL
